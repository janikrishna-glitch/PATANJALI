    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-sections">
          ...
          <div className="footer-section" style={{marginLeft:'45px' ,fontSize:'16px'}}>
            <h3>CONTACT US</h3>
            ...
            <img src="https://www.patanjaliayurved.net/media/images/apple-store.png" alt="Get it on the App Store" />
        </a>
        ...
        <div className="footer-bottom">
          <h6>&copy; 2024 Patanjali Ayurved Limited All Rights Reserved.</h6>
        </div>
      </div>
    </footer>
  );
